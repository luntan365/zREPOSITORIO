<form class="" action="__cadastro/validar_contabancaria" autocomplete="off" method="post" enctype="multipart/form-data">
  ...
  <span class="caixa-rotulo-contabancaria">Conta Bancária</span>
    ...
    <div class="botoes">
      <input type="submit" name="submit" class="botao-contabancaria" value="Adicionar Conta Bancária">
    </div>
