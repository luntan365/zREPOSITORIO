...
if (!$_SERVER['REQUEST_METHOD']=='POST') {  header("Location: ".DOMINIO); }
  ...
  if ($validado_ok):
    try {
      $crud->insert_usuario_pessoa($sexo, $nome, $email, $estado, $cidade, $telefone, $foto, $senha);
      ...
      if (isset($sexo)): $_SESSION['salvo_valida_sexo'] = $sexo; endif;
      ...
      header("Location: ".DOMINIO."cadastro/pessoa");
    }
