...
from dejotalib.listatouch import ListaTouch
from dejotalib.crud import Crud
...
KIVY_FONTS = [
    {
        ...
        "fn_bold": "data/fonts/Roboto-Bold.ttf",
        "fn_italic": "data/fonts/Roboto-Italic.ttf",
        "fn_bolditalic": "data/fonts/Roboto-BoldItalic.ttf"
    }
]
...
class Tela(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.ti_nome = TextInput(text='àncônrá' ,font_size='30sp', multiline=False, font_name='Roboto',  bold=True, italic=True)
        self.bl_add.add_widget(self.ti_nome)
        self.bl_add.add_widget(Button(text='Adicionar', font_size='30sp', on_press=self.add_pessoa_add))
        self.bl_add.add_widget(Button(text='Cancelar', font_size='30sp', on_press=self.cancelar))
        ...
        self.bl_reset.add_widget(Button(text='Resetar', font_size='30sp', on_press=self.resetar_confirma))
        self.bl_reset.add_widget(Button(text='Cancelar', font_size='30sp', on_press=self.cancelar))
    ...
    def pagou(self):
        self.conteiner.clear_widgets()
        self.conteiner.add_widget(ListaTouch(listatouch=crud.listar(1), acao=self.acao_pedente))
    ...
    def remover_pessoa(self):
        self.conteiner.clear_widgets()
        self.conteiner.add_widget(ListaTouch(listatouch=crud.listar_todos(), acao=self.acao_apagar))
